...
public class Assert {
    ...
    public static void fail(CodeEnum CodeEnum) {
        if (CodeEnum != null) {
     ...
     * @
     */
    public static void isTrue(boolean condition, CodeEnum CodeEnum) {
        if (!condition) {
            fail(CodeEnum);
        }
    }
     ...
     * @
     */
    public static void isFalse(boolean condition, CodeEnum CodeEnum) {
        if (condition) {
            fail(CodeEnum);
        }
    }
    ...
    /**
     * 断言检查这个对象不是 Null。 如果是null，用给定的错误码<code>CodeEnum</code>抛出异常
     * {@link BusinessException}
     *
     * @param CodeEnum 错误码
     * @param object        检查对象
    ...
    /**
     * 断言检查这个对象是 Null。 如果不是null，用给定的错误码<code>CodeEnum</code>抛出异常
     * {@link BusinessException}
     *
     * @param message 错误码
     * @param object        检查对象
    ...
    /**
     * 断言检查这个对象是 空。 如果不是null，用给定的错误码<code>CodeEnum</code>抛出异常
     * {@link BusinessException}
     *
     * @param CodeEnum 错误码
     * @param str        检查对象
     * @
     */
    public static void notBlank(Object str, CodeEnum CodeEnum) {
    ...
    public static <T> void notEmpty(T[] array, CodeEnum CodeEnum) {
     ...
     * @
     */
    public static void notEmpty(String value, CodeEnum CodeEnum) {
     ...
     * @
     */
    public static void notEquals(Object unexpected, Object actual, CodeEnum CodeEnum) {
     ...
     * @
     */
    public static void equals(String expected, String actual, CodeEnum CodeEnum) {
