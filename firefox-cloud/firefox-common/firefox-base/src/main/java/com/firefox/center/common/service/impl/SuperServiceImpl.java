package com.firefox.center.common.service.impl;
...
import com.firefox.center.common.exception.IdempotencyException;
import com.firefox.center.common.exception.LockException;
import com.firefox.center.common.lock.DistributedLock;
import com.firefox.center.common.service.ISuperService;
    ...
    public boolean saveOrUpdateIdempotency(T entity, DistributedLock lock, String lockKey, Wrapper<T> countWrapper, String msg) {
        if (null != entity) {
            ...
            if (null != tableInfo && StringUtils.isNotEmpty(tableInfo.getKeyProperty())) {
                ...
                if (idVal==null || Objects.isNull(getById((Serializable) idVal))) {
                    if (StrUtil.isEmpty(msg)) {
                        msg = "已存在";
                    }
