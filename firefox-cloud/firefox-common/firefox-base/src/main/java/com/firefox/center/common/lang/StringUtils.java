...
package com.firefox.center.common.lang;

import com.firefox.center.common.collect.ListUtils;
import com.firefox.center.common.utils.EncodeUtil;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static final String RANDOM_NUMBER = "num";
	public static final String RANDOM_LOWER = "lower";
	public static final String RANDOM_LOWER_NUMBER = "lower_number";
	public static final String RANDOM_CAPITAL = "capital";
	public static final String RANDOM_CAPITAL_NUMBER = "capital_number";
	public static final String RANDOM_LETTER = "letter";
	public static final String RANDOM_ALL = "all";
	 ...
	 * @return
	 */
	public static String getRandomStr(String type, int count) {
		...
		switch (type) {
			case RANDOM_NUMBER:
				for (int i = 0; i < count; i++) {
					String r = String.valueOf(number[random.nextInt(number.length)]);
					s.append(r);
				}
				break;
			case RANDOM_LOWER:
				for (int i = 0; i < count; i++) {
					String r = String.valueOf(lowercase[random.nextInt(lowercase.length)]);
					s.append(r);
				}
				break;
			case RANDOM_LOWER_NUMBER:
				both = (char[]) ArrayUtils.addAll(number, lowercase);
				for (int i = 0; i < count; i++) {
					String r = String.valueOf(both[random.nextInt(both.length)]);
					s.append(r);
				}
				break;
			case RANDOM_CAPITAL:
				for (int i = 0; i < count; i++) {
					String r = String.valueOf(capital[random.nextInt(capital.length)]);
					s.append(r);
				}
				break;
			case RANDOM_CAPITAL_NUMBER:
				both = (char[]) ArrayUtils.addAll(number, capital);
				for (int i = 0; i < count; i++) {
					String r = String.valueOf(both[random.nextInt(both.length)]);
					s.append(r);
				}
				break;
			case RANDOM_LETTER:
				both = (char[]) ArrayUtils.addAll(lowercase, capital);
				for (int i = 0; i < count; i++) {
					String r = String.valueOf(both[random.nextInt(both.length)]);
					s.append(r);
				}
			...
			case RANDOM_ALL:
				both = (char[]) ArrayUtils.addAll(number, lowercase);
				both = (char[]) ArrayUtils.addAll(both, capital);
				for (int i = 0; i < count; i++) {
					String r = String.valueOf(both[random.nextInt(both.length)]);
					s.append(r);
				}
	...
	public static String getRandom(int count) {
		return getRandomStr(RANDOM_LOWER_NUMBER, count);
	}
	...
	public static String getRandomNum(int count) {
		return getRandomStr(RANDOM_NUMBER, count);
	}
	 ...
	 * @return
	 */
	public static String getRandomAll(int count) {
		return getRandomStr(RANDOM_ALL, count);
	}
...
//	}
	...
	public static void main(String[] args) {
		char[] first = {'0', '1', '2' };
		char[] second = {'3', '4', '5', '6', '7', '8', '9' };
		char[] both = (char[]) ArrayUtils.addAll(first, second);
		System.out.println(getRandomStr(RANDOM_ALL, 10));
	}
