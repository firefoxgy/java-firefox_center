...
public interface SecurityConstants {
     ...
     * 用户信息头
     */
    String HEADER_APPID = "AppId";

    /**
     * 用户信息头
     */
    String HEADER_TENANTID = "TenantId";
     ...
     * 角色信息头
     */
    String HEADER_ROLE = "x-role-header";
     ...
     */
    String CACHE_CLIENT_KEY = "oauth_client";

    /**
     * 缓存套餐信息的redis key，这里是hash结构存储
     */
    String CACHE_PACKAGE_KEY = "oauth_client_packege";
     ...
     * PASSWORD模式登录处理地址
     */
    String PASSWORD_LOGIN_PRO_URL = "/user/token";
    /**
     * 获取授权码地址
     */
     ...
     * token信息app_id
     */
    String TOKEN_KEY_APP_ID = "app_id";
