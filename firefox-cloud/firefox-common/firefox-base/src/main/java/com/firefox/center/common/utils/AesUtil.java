...
import com.firefox.center.common.lang.ExceptionUtils;
...
public class AesUtil {
	...
	public static String genKeyString() {
		return EncodeUtil.encodeHex(genKey(DEFAULT_AES_KEYSIZE));
	}
	...
	public static String encode(String input) {
		try {
			return EncodeUtil.encodeHex(encode(input.getBytes(DEFAULT_URL_ENCODING), DEFAULT_KEY));
	...
	public static String encode(String input, String key) {
		try {
			return EncodeUtil.encodeHex(encode(input.getBytes(DEFAULT_URL_ENCODING), EncodeUtil.decodeHex(key)));
		} catch (UnsupportedEncodingException e) {
			return "";
		}
	}
	...
	public static String decode(String input) {
		try {
			return new String(decode(EncodeUtil.decodeHex(input), DEFAULT_KEY), DEFAULT_URL_ENCODING);
		} catch (UnsupportedEncodingException e) {
			return "";
		}
	}
	...
	public static String decode(String input, String key) {
		try {
			return new String(decode(EncodeUtil.decodeHex(input), EncodeUtil.decodeHex(key)), DEFAULT_URL_ENCODING);
		} catch (UnsupportedEncodingException e) {
			return "";
		}
	}
