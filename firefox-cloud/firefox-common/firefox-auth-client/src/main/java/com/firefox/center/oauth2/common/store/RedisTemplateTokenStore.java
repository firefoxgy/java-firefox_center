...
/**
 * https://blog.51cto.com/u_13005375/2052587
 * https://gitee.com/owenwangwen/open-capacity-platform/tree/master/oauth-center/auth-server
 * 支持redis cluster模式
 *
 * @Author: sujie
 * @date 2021/04/27 11:33
 */
@Slf4j
public class RedisTemplateTokenStore implements TokenStore {
    ...
    public OAuth2Authentication readAuthenticationForRefreshToken(String token) {
        OAuth2Authentication oAuth2Authentication=(OAuth2Authentication) this.redisTemplate.opsForValue().get(REFRESH_AUTH + token);
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        ...
        if (authentication.getUserAuthentication() instanceof UsernamePasswordAuthenticationToken) {
            ...
            LoginAdminUser appUser = (LoginAdminUser) authenticationToken.getPrincipal();
