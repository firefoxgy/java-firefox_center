package com.firefox.center.oauth2.common.service.impl;
...
import com.firefox.center.common.model.TSysMenu;
import com.firefox.center.common.utils.SysUserUtil;
import com.firefox.center.oauth2.common.service.IPermissionService;
...
public abstract class DefaultPermissionServiceImpl implements IPermissionService {
     ...
     * @return
     */
    public abstract List<TSysMenu> findMenuByRoleCodes(String roleCodes);
    ...
    public boolean hasPermission(HttpServletRequest request, Authentication authentication) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            List<TSysMenu> menuList = findMenuByRoleCodes(roleCodes);
