...
import com.firefox.center.oauth.jwt.JWTokenEnhancer;
...
@Import(ClientDetailsConfig.class)
@AutoConfigureAfter({ClientDetailsConfig.class, AuthorizationServerEndpointsConfigurer.class})
