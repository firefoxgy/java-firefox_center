package com.firefox.center.sys.common.system.util;
...
import com.firefox.center.sys.common.util.SpringContextUtils;
...
public class JwtUtil {
	...
	public static String sign(String key, String value, String secret) {
		Algorithm algorithm = Algorithm.HMAC256(secret);
		// 附带username信息
	 ...
	 * @param request
	 * @return
	 * @throws FirefoxException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws FirefoxException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new FirefoxException("未获取到用户");
		}
		return username;
	}
