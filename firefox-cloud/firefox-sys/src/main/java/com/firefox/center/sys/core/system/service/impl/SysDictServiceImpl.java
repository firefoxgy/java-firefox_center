...
import com.firefox.center.sys.core.system.mapper.SysDictMapper;
...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements ISysDictService {
	...
	@Override
	@Cacheable(value = CacheConstant.Sys.SYS_DICT_CACHE,key = "#code+':'+#key")
	 ...
	 */
	@Override
	//@Cacheable(value = CacheConstant.Sys.SYS_DICT_TABLE_CACHE)
	 ...
	 */
	@Override
	@Cacheable(value = CacheConstant.Sys.SYS_DICT_TABLE_BY_KEYS_CACHE)
	public List<String> queryTableDictByKeys(String table, String text, String code, String keys) {
		...
		List<DictModel> dicts = baseMapper.queryTableDictByKeys(table, text, code, keyArray);
