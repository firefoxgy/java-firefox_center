...
import com.firefox.center.sys.config.mybatis.TenantParser;
import com.firefox.center.sys.core.system.util.TenantContext;
...
/**
 * 单数据源配置（firefox.datasource.open = false时生效）
 * @Author zhoujf
 *
 */
@Configuration
@MapperScan(value={"com.firefox.**.mapper*"})
