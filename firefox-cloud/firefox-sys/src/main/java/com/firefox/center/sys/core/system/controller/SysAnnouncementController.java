...
import com.firefox.center.sys.common.constant.CommonSendStatus;
...
import com.firefox.center.sys.core.system.service.ISysAnnouncementService;
...
public class SysAnnouncementController {
	...
	public R<IPage<SysAnnouncement>> queryPageList(SysAnnouncement sysAnnouncement,
												   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
												   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
												   HttpServletRequest req) {
		R<IPage<SysAnnouncement>> result = new R<IPage<SysAnnouncement>>();
	...
	public R<SysAnnouncement> add(@RequestBody SysAnnouncement sysAnnouncement) {
		R<SysAnnouncement> result = new R<SysAnnouncement>();
		try {
			sysAnnouncement.setDelFlag(CommonConstant.DEL_FLAG_0.toString());
	...
	public R<SysAnnouncement> eidt(@RequestBody SysAnnouncement sysAnnouncement) {
		R<SysAnnouncement> result = new R<SysAnnouncement>();
	...
	public R<SysAnnouncement> delete(@RequestParam(name="id",required=true) String id) {
		R<SysAnnouncement> result = new R<SysAnnouncement>();
		...
		if(sysAnnouncement==null) {
			...
			if(sysAnnouncementService.updateById(sysAnnouncement)) {
				result.okMsg("删除成功!");
			}
		}
	...
	public R<SysAnnouncement> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
		R<SysAnnouncement> result = new R<SysAnnouncement>();
	...
	public R<SysAnnouncement> queryById(@RequestParam(name="id",required=true) String id) {
		R<SysAnnouncement> result = new R<SysAnnouncement>();
		SysAnnouncement sysAnnouncement = sysAnnouncementService.getById(id);
		if(sysAnnouncement==null) {
			result.errorMsg("未找到对应实体");
		}else {
			result.setData(sysAnnouncement);
			result.setSuccess(true);
		}
		return result;
	}
	...
	public R<SysAnnouncement> doReleaseData(@RequestParam(name="id",required=true) String id, HttpServletRequest request) {
		R<SysAnnouncement> result = new R<SysAnnouncement>();
		SysAnnouncement sysAnnouncement = sysAnnouncementService.getById(id);
		if(sysAnnouncement==null) {
			result.errorMsg("未找到对应实体");
	...
	public R<SysAnnouncement> doReovkeData(@RequestParam(name="id",required=true) String id, HttpServletRequest request) {
		R<SysAnnouncement> result = new R<SysAnnouncement>();
		SysAnnouncement sysAnnouncement = sysAnnouncementService.getById(id);
		if(sysAnnouncement==null) {
			result.errorMsg("未找到对应实体");
    ...
    public R<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        ...
        for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
            ...
            try {
                ...
                return R.ok("文件导入成功！数据行数：" + listSysAnnouncements.size());
            } catch (Exception e) {
                log.error(e.getMessage(),e);
	...
	public R<SysAnnouncement> syncNotic(@RequestParam(name="anntId",required=false) String anntId, HttpServletRequest request) {
		R<SysAnnouncement> result = new R<SysAnnouncement>();
		JSONObject obj = new JSONObject();
