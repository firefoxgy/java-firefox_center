...
import com.firefox.center.sys.config.interceptor.AnnotationInterceptor;
import com.firefox.center.sys.core.shiro.authc.interceptor.OnlineInterceptor;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		String [] exculudes = new String[]{"/*.html","/html/**","/js/**","/css/**","/images/**","/image/**"};
		registry.addInterceptor(onlineInterceptor()).excludePathPatterns(exculudes).addPathPatterns("/online/cgform/api/**");
		registry.addInterceptor(annotationInterceptor()).addPathPatterns("/api/**");
	}
}
