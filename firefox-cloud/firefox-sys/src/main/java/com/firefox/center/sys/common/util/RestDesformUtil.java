...
public class RestDesformUtil {
     ...
     * @return
     */
    public static R queryOne(String desformCode, String dataId, String token) {
     ...
     * @return
     */
    public static R addOne(String desformCode, JSONObject formData, String token) {
     ...
     * @return
     */
    public static R editOne(String desformCode, JSONObject formData, String token) {
        return addOrEditOne(desformCode, formData, token, HttpMethod.PUT);
    }

    private static R addOrEditOne(String desformCode, JSONObject formData, String token, HttpMethod method) {
     ...
     * @return
     */
    public static R removeOne(String desformCode, String dataId, String token) {
        String url = getBaseUrl(desformCode, dataId).toString();
        HttpHeaders headers = getHeaders(token);
    ...
    private static R packageReturn(ResponseEntity<JSONObject> result) {
        if (result.getBody() != null) {
            return result.getBody().toJavaObject(R.class);
        }
        return R.error("操作失败");
    }
