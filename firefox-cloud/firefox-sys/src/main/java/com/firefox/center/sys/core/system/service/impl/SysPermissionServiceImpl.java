...
import com.firefox.center.sys.core.system.mapper.SysDepartPermissionMapper;
import com.firefox.center.sys.core.system.mapper.SysDepartRolePermissionMapper;
import com.firefox.center.sys.core.system.mapper.SysPermissionMapper;
import com.firefox.center.sys.core.system.mapper.SysRolePermissionMapper;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	private final SysDepartPermissionMapper sysDepartPermissionMapper;
	private final SysDepartRolePermissionMapper sysDepartRolePermissionMapper;
	...
	@Override
	@Transactional
	@CacheEvict(value = CacheConstant.Sys.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void deletePermission(String id) throws FirefoxException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new FirefoxException("未找到菜单信息");
		}
	...
	@Override
	@CacheEvict(value = CacheConstant.Sys.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	//@CacheEvict(value = CacheConstant.Sys.SYS_DATA_PERMISSIONS_CACHE,allEntries=true,condition="#sysPermission.menuType==2")
	public void deletePermissionLogical(String id) throws FirefoxException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new FirefoxException("未找到菜单信息");
		}
	...
	@Override
	@CacheEvict(value = CacheConstant.Sys.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void addPermission(SysPermission sysPermission) throws FirefoxException {
		//----------------------------------------------------------------------
		//判断是否是一级菜单，是的话清空父菜单
	...
	@Override
	@CacheEvict(value = CacheConstant.Sys.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void editPermission(SysPermission sysPermission) throws FirefoxException {
	 ...
	 */
	@Override
	@Cacheable(value = CacheConstant.Sys.SYS_DATA_PERMISSIONS_CACHE)
