...
import com.firefox.center.sys.common.constant.DataBaseConstant;
...
import com.firefox.center.sys.common.system.vo.*;
...
import com.firefox.center.sys.core.system.mapper.*;
import com.firefox.center.sys.core.system.service.ISysDataSourceService;
...
public class SysBaseApiImpl implements ISysBaseAPI {
	...
	@Override
	@Cacheable(cacheNames=CacheConstant.Sys.SYS_USERS_CACHE, key="#username")
	...
	@Override
	@Cacheable(value = CacheConstant.Sys.SYS_DICT_CACHE,key = "#code")
	...
	@Override
    public String parseTemplateByCode(String templateCode,Map<String, Object> map) {
        List<SysMessageTemplate> sysSmsTemplates = sysMessageTemplateService.selectByCode(templateCode);
        if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
            throw new FirefoxException("消息模板不存在，模板编码："+templateCode);
        }
	...
	@Override
	public void sendSysAnnouncement(String fromUser, String toUser,String title, Map<String, Object> map, String templateCode) {
		List<SysMessageTemplate> sysSmsTemplates = sysMessageTemplateService.selectByCode(templateCode);
        if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
            throw new FirefoxException("消息模板不存在，模板编码："+templateCode);
        }
	...
	@Override
	public void sendSysAnnouncement(String fromUser, String toUser, String title, Map<String, Object> map, String templateCode, String busType, String busId) {
		List<SysMessageTemplate> sysSmsTemplates = sysMessageTemplateService.selectByCode(templateCode);
		if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
			throw new FirefoxException("消息模板不存在，模板编码："+templateCode);
		}
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new FirefoxException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
