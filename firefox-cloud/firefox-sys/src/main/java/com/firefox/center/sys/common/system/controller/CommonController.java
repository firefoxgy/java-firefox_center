package com.firefox.center.sys.common.system.controller;
...
import com.firefox.center.sys.common.util.RestUtil;
import com.firefox.center.sys.common.util.TokenUtils;
...
public class CommonController {
	...
	@Value(value = "${firefox.upload.path}")
	...
	public R<?> upload(HttpServletRequest request, HttpServletResponse response) {
		...
		if(CommonConstant.UPLOAD_TYPE_LOCAL.equals(uploadType)){
			...
			if(oConvertUtils.isNotEmpty(jeditor)){
				return R.ok(CommonConstant.UPLOAD_TYPE_LOCAL);
			}else{
	...
	private String uploadLocal(MultipartFile mf,String bizPath){
		try {
			...
			File file = new File(ctxPath + File.separator + bizPath +new SimpleDateFormat("/yyyy/MM/dd/").format(new Date()));
			if (!file.exists()) {
				file.mkdirs();// 创建文件根目录
			}
...
//	}
    ...
    public R transitRESTful(@RequestParam("url") String url, HttpServletRequest request) {
        try {
