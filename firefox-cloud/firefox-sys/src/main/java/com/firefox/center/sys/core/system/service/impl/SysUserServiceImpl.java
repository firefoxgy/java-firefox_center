...
import com.firefox.center.sys.common.system.vo.SysUserCacheInfo;
import com.firefox.center.sys.common.util.PasswordUtil;
import com.firefox.center.sys.common.util.UUIDGenerator;
...
import com.firefox.center.sys.core.system.vo.SysUserDepVo;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
    ...
    @Override
    @CacheEvict(value = {CacheConstant.Sys.SYS_USERS_CACHE}, allEntries = true)
    public R<?> resetPassword(String username, String oldpassword, String newpassword, String confirmpassword) {
    ...
    @Override
    @CacheEvict(value = {CacheConstant.Sys.SYS_USERS_CACHE}, allEntries = true)
    public R<?> changePassword(SysUser sysUser) {
...
//		info.setSysUserName(user.getRealname());
	...
	@Override
	@CacheEvict(value= {CacheConstant.Sys.SYS_USERS_CACHE}, key="#username")
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	public R<?> checkUserIsEffective(SysUser sysUser) {
		R<?> result = new R<Object>();
		//情况1：根据用户信息查询，该用户不存在
		if (sysUser == null) {
			result.errorMsg("该用户不存在，请注册");
