...
public interface CommonConstant {
     ...
     * 禁用
     */
    public static final Integer DISABLE_FLAG = 0;
    ...
    /**访问权限认证未通过 510*/
    public static final Integer SC_FIREFOX_NO_AUTHZ=510;

    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:com.firefox.center.admin.core.shiro.authc.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
