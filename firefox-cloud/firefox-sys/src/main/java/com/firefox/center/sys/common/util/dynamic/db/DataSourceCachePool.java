package com.firefox.center.sys.common.util.dynamic.db;
...
import com.firefox.center.sys.common.system.vo.DynamicDataSourceModel;
...
public class DataSourceCachePool {
    ...
    public static DynamicDataSourceModel getCacheDynamicDataSourceModel(String dbKey) {
        String redisCacheKey = CacheConstant.Sys.SYS_DYNAMICDB_CACHE + dbKey;
    ...
    public static void cleanAllCache() {
        ...
        for(Map.Entry<String, DruidDataSource> entry : dbSources.entrySet()){
            ...
            //清空redis缓存
            getRedisTemplate().delete(CacheConstant.Sys.SYS_DYNAMICDB_CACHE + dbkey);
        }
        //清空缓存
        dbSources.clear();
    }
