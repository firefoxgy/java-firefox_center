package com.firefox.center.sys.common.es;
...
public class ElasticsearchTemplate {
    ...
    public ElasticsearchTemplate(@Value("${firefox.elasticsearch.cluster-nodes}") String baseUrl, @Value("${firefox.elasticsearch.check-enabled}") boolean checkEnabled) {
