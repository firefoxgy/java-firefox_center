...
import com.firefox.center.sys.common.aspect.annotation.Dict;
...
public class DictAspect {
    ...
    // 定义切点Pointcut
    @Pointcut("execution(public * com.firefox..*.*Controller.*(..))")
     ...
     * 字典注入实现 通过对实体类添加注解@dict 来标识需要的字典内容,字典分为单字典code即可 ，table字典 code table text配合使用与原来firefox的用法相同
