...
import com.firefox.center.sys.common.constant.FillRuleConstant;
import com.firefox.center.sys.common.util.FillRuleUtil;
import com.firefox.center.sys.common.util.YouBianCodeUtil;
...
import com.firefox.center.sys.core.system.util.FindsDepartsChildrenUtil;
...
public class SysDepartServiceImpl extends ServiceImpl<SysDepartMapper, SysDepart> implements ISysDepartService {
	 ...
	 */
	@Cacheable(value = CacheConstant.Sys.SYS_DEPARTS_CACHE)
	@Override
	...
	@Cacheable(value = CacheConstant.Sys.SYS_DEPART_IDS_CACHE)
	@Override
