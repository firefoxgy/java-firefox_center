...
import com.firefox.center.sys.common.util.dynamic.db.DataSourceCachePool;
import com.firefox.center.sys.core.system.entity.SysDataSource;
...
public class SysDataSourceController extends BaseController<SysDataSource, ISysDataSourceService> {
    ...
    public R<?> queryOptions(SysDataSource sysDataSource, HttpServletRequest req) {
        QueryWrapper<SysDataSource> queryWrapper = QueryGenerator.initQueryWrapper(sysDataSource, req.getParameterMap());
    ...
    public R<?> add(@RequestBody SysDataSource sysDataSource) {
    ...
    public R<?> edit(@RequestBody SysDataSource sysDataSource) {
    ...
    public R<?> queryById(@RequestParam(name = "id") String id) {
        SysDataSource sysDataSource = sysDataSourceService.getById(id);
        return R.ok(sysDataSource);
    }
