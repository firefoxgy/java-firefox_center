  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          save: '/sys/config/sms/saveAppTenantSms',
          appTenantSms: '/sys/config/sms/appTenantSms',
    ...
    methods: {
      ...
      getAppTenantSms() {
        const that = this
        getAction(this.url.appTenantSms, {appId: this.appId, tenantId: this.tenantId}).then((res) => {
      ...
      handleOk() {
        ...
        let method = 'post'
        let formData = {appId: this.appId, tenantId: this.tenantId};
        if(this.smsId===-1){
