<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <Firefox-Order-modal-for-j-editable-table ref="modalForm" @ok="modalFormOk"/>
...
<script>
  ...
  import FirefoxOrderModalForJEditableTable from './modules/FirefoxOrderModalForJEditableTable'

  export default {
    name: 'FirefoxOrderMainListForJEditableTable',
    mixins: [FirefoxListMixin],
    components: {
      FirefoxOrderModalForJEditableTable
    },
    data() {
      return {
        description: '订单管理页面',
