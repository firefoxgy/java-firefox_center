...
<script>
  ...
  import JSelectDepart from '@/components/firefoxbiz/JSelectDepart'
  import JSelectUserByDep from '@/components/firefoxbiz/JSelectUserByDep'
  import JSelectMultiUser from '@/components/firefoxbiz/JSelectMultiUser'
  import JSelectRole from '@/components/firefoxbiz/JSelectRole'
  import JCheckbox from '@/components/firefox/JCheckbox'
  import JCodeEditor from '@/components/firefox/JCodeEditor'
  import JDate from '@/components/firefox/JDate'
  import JEditor from '@/components/firefox/JEditor'
  import JEllipsis from '@/components/firefox/JEllipsis'
  import JSlider from '@/components/firefox/JSlider'
  import JSelectMultiple from '@/components/firefox/JSelectMultiple'
  import JTreeDict from "../../components/firefox/JTreeDict.vue";
  import JCron from "@/components/firefox/JCron.vue";
  import JTreeSelect from '@/components/firefox/JTreeSelect'
  import JSuperQuery from '@/components/firefox/JSuperQuery'
  import JUpload from '@/components/firefox/JUpload'
  import JImageUpload from '@/components/firefox/JImageUpload'
  import JSelectPosition from '@comp/firefoxbiz/JSelectPosition'
  import JCategorySelect from '@comp/firefox/JCategorySelect'
  import JMultiSelectTag from '@comp/dict/JMultiSelectTag'
  import JInput from '@comp/firefox/JInput'
  import JAreaLinkage from '@comp/firefox/JAreaLinkage'
  import JMarkdownEditor from '@/components/firefox/JMarkdownEditor/index'
  ...
  export default {
    ...
    data() {
      return {
        ...
        userIds: 'admin',
        multiUser: 'admin,firefox',
        jcheckbox: {
          values: 'spring,firefoxboot',
          options: [
            { label: 'Firefox', value: 'firefox' },
            { label: 'Firefox-Boot', value: 'Firefox-Boot' },
