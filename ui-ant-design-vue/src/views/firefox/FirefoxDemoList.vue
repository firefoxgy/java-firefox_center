<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <firefoxDemo-modal ref="modalForm" @ok="modalFormOk"></firefoxDemo-modal>

    <!-- 一对多表单区域 -->
    <FirefoxDemoTabsModal ref="firefoxgDemoTabsModal" @ok="modalFormOk"></FirefoxDemoTabsModal>

  </a-card>
</template>

<script>
  import FirefoxDemoModal from './modules/FirefoxDemoModal'
  import JSuperQuery from '@/components/firefox/JSuperQuery.vue';
  import JInput from '@/components/firefox/JInput.vue';
  import FirefoxDemoTabsModal from './modules/FirefoxDemoTabsModal'
  ...
  export default {
    ...
    methods: {
      ...
      //跳转单据页面
      jump() {
        this.$router.push({path: '/firefox/helloworld'})
      },
