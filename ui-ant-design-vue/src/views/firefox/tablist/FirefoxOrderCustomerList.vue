<template>
  <a-card :bordered="false">
    ...
    <!-- table区域-end -->
    <!-- 表单区域 -->
    <firefoxOrderCustomer-modal ref="modalForm" @ok="modalFormOk"></firefoxOrderCustomer-modal>
  </a-card>
</template>

<script>
  import FirefoxOrderCustomerModal from './form/FirefoxOrderCustomerModal'
  import FirefoxOrderDMainList from './FirefoxOrderDMainList'
  import {FirefoxListMixin} from '@/mixins/FirefoxListMixin'
  import {getAction} from '@/api/manage'

  export default {
    name: "firefoxOrderCustomerList",
    mixins: [FirefoxListMixin],
    components: {
      FirefoxOrderDMainList,
