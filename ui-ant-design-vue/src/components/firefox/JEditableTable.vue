...
<script>
  ...
  import JInputPop from '@/components/firefox/minipop/JInputPop'
  import JFilePop from '@/components/firefox/minipop/JFilePop'
    ...
    methods: {
      ...
      handleChangeUpload(info, id, row, column) {
        ...
        if (file.status === 'done') {
          ...
          value['message'] = file.response.msg || '未知错误'
        }
